...
{
    PushButtonCapability::PushButtonCapability(IInputHardwareAdapter *input_hardware_adapter, unsigned long toleranceTimeMs)
        : IInputCapability(input_hardware_adapter, PUSH_BUTTON_TYPE, PUSH_BUTTON_NO_PRESSED),
