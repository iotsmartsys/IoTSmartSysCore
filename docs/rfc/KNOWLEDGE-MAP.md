...
| Leitura de corrente contínua fotovoltaica | `docs/specs/CURRENT-SENSING-CAPABILITY.md` | Draft 0.6 — Ready | Implemented; revisão técnica e validação instrumentada pendentes (`EKM-CHG-0051`) |
