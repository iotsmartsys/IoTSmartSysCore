...
| Leitura de corrente contínua fotovoltaica | `docs/specs/CURRENT-SENSING-CAPABILITY.md` | Draft 0.6 — Ready | Not Started; 0.5 permanece histórica como Implemented/Ready (`EKM-CHG-0050`) |
