...
| Potência e energia por sensor abstrato | `docs/specs/POWER-ENERGY-CAPABILITY.md` | Draft 0.4 — Ready | Implemented; revisão e validação pendentes; versão 0.3 permanece baseline validada em `main` (`EKOM-CHG-0023`) |
