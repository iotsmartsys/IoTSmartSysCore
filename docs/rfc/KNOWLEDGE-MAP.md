...
**Última atualização:** 02/09/2026 (validação final da PowerEnergyCapability 0.3)
...
| Potência e energia por composição de sensores | `docs/specs/POWER-ENERGY-CAPABILITY.md` | Active 0.3 — Ready | Validated; encerramento confirmado pelo Arquiteto; `Ready for Integration` (`EKOM-CHG-0016`) |
...
- `EKOM-CHG-0016`: registra a validação declarada pelo Arquiteto, promove a
  versão 0.3 para `Active`/`Validated` e autoriza sua integração à `main`.
