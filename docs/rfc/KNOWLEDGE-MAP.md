...
| Sensores de tensão e corrente INA3221 | `docs/specs/INA3221-SENSORS.md` | Active 0.2 — Ready | Validated; encerramento confirmado pelo Arquiteto; `Ready for Integration` (`EKOM-CHG-0021`) |
...
- `EKOM-CHG-0021`: registra revisão aderente e validação em hardware declarada
  pelo Arquiteto, promove a versão 0.2 para `Active`/`Validated` e autoriza sua
  integração à `main`.
